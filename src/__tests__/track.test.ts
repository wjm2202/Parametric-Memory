...
function baseReport(): BenchmarkReport {
    return {
        ...
        latency: {
            ...
            accessP95Ms: 1.0,
            accessP99Ms: 2.0,
            contextLoadP50Ms: 1.0,
            contextLoadP95Ms: 2.0,
            contextLoadP99Ms: 3.0,
            commitP50Ms: 5.0,
            commitP95Ms: 10.0,
            commitP99Ms: 20.0,
            proofVerifyAvgMs: 0.05,
            proofVerifyP50Ms: 0.05,
            proofVerifyP95Ms: 0.05,
            proofVerifyP99Ms: 0.05,
            proofVerifyCv: 0,
        },
        prediction: {
            hitRate: 0.9,
        ...
        detail: {
            recall: {
                ...
                contextLoad: { requests: 1, latenciesMs: [1], p50: 1, p95: 1, p99: 1, max: 1, histogram: {} },
